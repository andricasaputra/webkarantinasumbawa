		...
		<div class="row">
			...
			<div class="mz-module" >
				<div class="mz-module-about" style="display: flex; justify-content: center; flex-direction: column; align-tems: center">
					<div class="section-title">
						<h2 class="judul text-center sub">E-Laporan Operasional</h2>
					</div>		
					<div style="display: flex; justify-content: center; margin-bottom: 50px; ">
						<img src="assets/img/org/aplikasi/e-laporan/home.png" width="1000" style="border-radius: 20px" />
					</div>

					<div style="display: flex; justify-content: center; margin-bottom: 50px;">
						<img src="assets/img/org/aplikasi/e-laporan/kh_home.png" width="1000" border-radius: 20px />		
					</div>

					<div style="display: flex; justify-content: center; margin-bottom: 50px;">
						<img src="assets/img/org/aplikasi/e-laporan/kt_home.png" width="1000" border-radius: 20px />		
					</div>

					<div style="display: flex; justify-content: center; margin-bottom: 50px;">
						<img src="assets/img/org/aplikasi/e-laporan/screenshot.png" width="1000" border-radius: 20px />		
					</div>

					<div style="display: flex; justify-content: center; margin-bottom: 50px;">
						<img src="assets/img/org/aplikasi/e-laporan/screenshot2.png" width="1000" border-radius: 20px />		
					</div>

					<div style="display: flex; justify-content: center; margin-bottom: 50px;">
						<a href="http://e-office.eqosistem.com" target="_blank"><h3>Link Aplikasi e-office</h3></a>		
					</div>
