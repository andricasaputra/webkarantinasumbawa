<?php  
  ...
  if(isset($_REQUEST['id'])){
    ...
    $tampil = $keuangan->TampilDaftarAset($id);
...
<script type="text/javascript">
  $("#form_edit_daftar_aset").on("submit", (function(e){

 e.preventDefault();

 $.ajax({

   url :'controller/proses_edit_daftar_aset.php',
   ...
   success : function(data){
        ...
        alert('data berhasil diubah');
          ...
          window.location.href = '?halaman=daftar_aset';
