<?php  
  ...
  if(isset($_REQUEST['id'])){
    ...
    $tampil = $keuangan->TampilRenstra($id);
...
<div class="modal-content" id="modal-edit">
  <form id="form_edit_renstra">
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal">&times;</button>
      <h4 class="modal-title">Ubah Data Renstra</h4>
    </div>
...
<script type="text/javascript">
  $("#form_edit_renstra").on("submit", (function(e){

 e.preventDefault();

 $.ajax({

   url :'controller/proses_edit_renstra.php',
   ...
   success : function(data){
        ...
        alert('data berhasil diubah');
          ...
          window.location.href = '?halaman=renstra';
