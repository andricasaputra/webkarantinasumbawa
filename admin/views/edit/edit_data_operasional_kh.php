<?php  
  ...
  if(isset($_REQUEST['id'])){
    ...
    $tampil = $conn->data_operasional_kh($id);
...
<div class="modal-content">
  <form id="form_edit">
    <div class="modal-header">
      ...
      <h4 class="modal-title">Ubah Data Operasional Karantina Hewan</h4>
    </div>
...
<script type="text/javascript">
 ...
 $.ajax({
   ...
   url :'controller/proses_edit_data_operasioanl_kh.php',
   ...
   success : function(data){
        ...
        alert('data berhasil diubah');
          ...
          window.location.href = '?halaman=data_operasional_kh';
