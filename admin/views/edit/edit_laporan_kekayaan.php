<?php  
  ...
  if(isset($_REQUEST['id'])){
    ...
    $tampil = $keuangan->TampilLaporanKekayaan($id);
...
<div class="modal-content" id="modal-edit">
  <form id="form_edit_neraca_keuangan">
    <div class="modal-header">
      ...
      <h4 class="modal-title">Ubah Laporan Kekayaan (LHKPN)</h4>
    </div>
...
<script type="text/javascript">
 ...
 $.ajax({
   ...
   url :'controller/proses_edit_laporan_kekayaan.php',
   ...
   success : function(data){
        ...
        alert('data berhasil diubah');
          ...
          window.location.href = '?halaman=laporan_kekayaan';
