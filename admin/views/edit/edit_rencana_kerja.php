<?php  
  ...
  $kinerja = new berita($db);

  if(isset($_REQUEST['id'])){

    $id = intval($_REQUEST['id']);

    $tampil = $kinerja->TampilRencanaKerja($id);
...
<div class="modal-content" id="modal-edit">
  <form id="form_edit_rencana_kerja">
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal">&times;</button>
      <h4 class="modal-title">Ubah Data Neraca Keuangan</h4>
    </div>
...
<script type="text/javascript">
  $("#form_edit_rencana_kerja").on("submit", (function(e){

 e.preventDefault();

 $.ajax({

   url :'controller/proses_edit_rencana_kerja.php',
   ...
   success : function(data){
        ...
        alert('data berhasil diubah');
          ...
          window.location.href = '?halaman=rencana_kerja';
