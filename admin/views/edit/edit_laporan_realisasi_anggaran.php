<?php  
  ...
  if(isset($_REQUEST['id'])){
    ...
    $tampil = $keuangan->TampilLaporanRealisasiAnggaran($id);
...
<div class="modal-content" id="modal-edit">
  <form id="form_edit_realisasi_anggaran">
    <div class="modal-header">
      ...
      <h4 class="modal-title">Ubah Laporan Realisasi Anggaran</h4>
    </div>
...
<script type="text/javascript">
 ...
 $.ajax({
   ...
   url :'controller/proses_edit_laporan_realisasi_anggaran.php',
   ...
   success : function(data){
        ...
        alert('data berhasil diubah');
          ...
          window.location.href = '?halaman=laporan_realisasi_anggaran';
