<?php  
  ...
  if(isset($_REQUEST['id'])){
    ...
    $tampil = $keuangan->TampilArusKas($id);
...
<div class="modal-content" id="modal-edit">
  <form id="form_edit_arus_kas">
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal">&times;</button>
      <h4 class="modal-title">Ubah Data Arus Kas</h4>
    </div>
...
<script type="text/javascript">
  $("#form_edit_arus_kas").on("submit", (function(e){

 e.preventDefault();

 $.ajax({

   url :'controller/proses_edit_arus_kas.php',
   ...
   success : function(data){
        ...
        alert('data berhasil diubah');
          ...
          window.location.href = '?halaman=arus_kas';
