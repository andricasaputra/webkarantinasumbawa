<?php  
  ...
  if(isset($_REQUEST['id'])){
    ...
    $tampil = $keuangan->TampilRka_kl($id);
...
<div class="modal-content" id="modal-edit">
  <form id="form_edit_dipa">
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal">&times;</button>
      <h4 class="modal-title">Ubah Data RKA-KL/h4>
    </div>
    <div class="modal-body">
      ...
      <div class="column-full">
          <label for="penulis">revisi</label>
          <input type="text" class="form-control" name="revisi" id="revisi" value="<?=$revisi;?>">
      </div>             
      <div class="column-full">
...
<script type="text/javascript">
  $("#form_edit_dipa").on("submit", (function(e){

 e.preventDefault();

 $.ajax({

   url :'controller/proses_edit_rka_kl.php',
   ...
   success : function(data){
        ...
        alert('data berhasil diubah');
          ...
          window.location.href = '?halaman=rka_kl';
