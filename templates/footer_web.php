        ...
        <div class="row">
            <div class="col-md-4">
                <div class="section-text">
                    ...
                    <p><i class="fa fa-envelope"></i> karantinasumbawa@pertanian.go.id</p>
                </div>
            </div>
...
<footer>
    <div class="container text-center">
        <p style="color: #fff">&copy; 2018 - <?php echo date('Y'); ?> | Stasiun Karantina Pertanian Kelas I Sumbawa Besar</p>
    </div>
</footer>
...
<script>
    ...
    $(document).ready(function() {
        ...
        if ($(window).width() > 800) {
            ...
            $('#cssmenu').prepend('<a class="navbar-brand page-scroll" href="home"><img src="images/logo-web-2.png" class="logo"></a>');
    ...
    $(document).ready(function() {
        ...
        function dataOperasionalCounter(url)
        {
            $.ajax({
                ...
                let domas = parseInt(response.kh.frekuensiPerKegiatan.domas || 0) + parseInt(response.kt.frekuensiPerKegiatan.domas || 0);

                let dokel = parseInt(response.kh.frekuensiPerKegiatan.dokel || 0) + parseInt(response.kt.frekuensiPerKegiatan.dokel || 0);

                let ekspor = parseInt(response.kh.frekuensiPerKegiatan.ekspor || 0) + parseInt(response.kt.frekuensiPerKegiatan.ekspor || 0);

                let impor = parseInt(response.kh.frekuensiPerKegiatan.impor || 0) + parseInt(response.kt.frekuensiPerKegiatan.impor || 0);
        ...
        function pieChart(container, data, title)
        {
            $(container).highcharts({
                ...
                series: [{
                    ...
                    data: [
                        ['<b>' + 'Domas' + '</b>', parseInt(data.frekuensiPerKegiatan.domas || 0)],
                        ['<b>' + 'Dokel' + '</b>', parseInt(data.frekuensiPerKegiatan.dokel || 0)],
                        ['<b>' + 'Ekspor' + '</b>', parseInt(data.frekuensiPerKegiatan.ekspor || 0)],
                        ['<b>' + 'Impor' + '</b>',  parseInt(data.frekuensiPerKegiatan.impor || 0)]
                    ],
                    showInLegend: true
                }]
            });
        ...
        $('#timeline-container').append(`
            ...
            <div class="col-md-4" style="margin-bottom: 10px">
                <a class="twitter-timeline" data-width="400" data-height="780" href="https://twitter.com/SKP_Sumbawa?ref_src=twsrc%5Etfw">Tweets by SKP_Sumbawa</a>
            </div>
            <div class="col-md-4" style="margin-bottom: 10px">
...
<!-- Google Reacaptcha -->
<script src="https://www.google.com/recaptcha/api.js?render=6LdzxMYUAAAAAFHreeW5J7uCfGV6aC43kzI9Hl3x"></script>

<script async defer>
    grecaptcha.ready(function() {
        grecaptcha.execute('6LdzxMYUAAAAAFHreeW5J7uCfGV6aC43kzI9Hl3x', {
